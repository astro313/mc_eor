...
\caption{Distribution of molecular gas density of \flower during the accreting phase shown in \Fig{SFH}{\em
    (b)} \AP{what is the normalization/axis here? I would plot the distribution such that the integral on the function is 1}.
\label{fig:h2density}}
\end{figure}
...
\label{fig:MCC}\AP{see \Fig{MMCidentification} for an alternative version}}
\end{figure*}
...
\caption{
Same as \Fig{MCC} for the quiescent phase of \flower, when the galaxy is supported by rotation.
\label{fig:MCC28} \AP{see \Fig{MMCidentification} for an alternative version}}
\end{figure*}

\begin{figure*}[htbp]
 \centering
  \includegraphics[width=0.49\textwidth]{\figpath/{dual_16_ncut_0.53}.pdf}
  \includegraphics[width=0.49\textwidth]{\figpath/{dual_28_ncut_0.53}.pdf}

  \includegraphics[width=0.49\textwidth]{\figpath/{dual_16_ncut_6.81}.pdf}
  \includegraphics[width=0.49\textwidth]{\figpath/{dual_28_ncut_6.81}.pdf}

  \includegraphics[width=0.49\textwidth]{\figpath/{dual_16_ncut_18.96}.pdf}
  \includegraphics[width=0.49\textwidth]{\figpath/{dual_28_ncut_18.96}.pdf}
\caption{\AP{proposed alternative to substitute \Fig{MCC} and \Fig{MCC28}; if adopted, label with the phase should be included in the first row}
\label{fig:MMCidentification}
}
\end{figure*}
...
%
The accreting phase (\Fig{MCC}) of \flower displays a more disturbed morphology compared to the quiescent phase, which displays a disk-like morphology (\Fig{MCC28}).
%
