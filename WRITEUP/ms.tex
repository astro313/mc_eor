...
$n_{\rm cut}$, as illustrated by the colorbar on the right.
We also plot gas-only $\alpha_{\rm vir}$ (orange star symbols), which is of the same order of magnitude as $\alpha_{\rm vir, tot}$ for most MCCs,
