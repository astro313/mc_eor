...
\caption{$\alpha_{\rm vir}$-mass relation for pre-starburst (left) and starburst phase. 
...
\DL{
1) Note becasuse some MCCs have high stellar-to-gas mass ratios, we plot both gas-only virial parameter 
and the total virial parameter (eqn xx) on the alphavir-mass plots in \Fig{}. The former is used in \obs since 
the quantities are measured using gas tracers. On the other hand, because our MCs are identified with gas density and 
some have high stellar-to-gas mass ratio, influence from the stellar component plays a non-negligible role, as seen in Toomre Q analysis.
% 
...
% 
3) add alphavir versus stellar-to-gas mass ratio, 
which shows in the pre-SB phase, we see overall lower alphavir. 
We interpret the alphavir versus stellar-to-gas mass ratio plot as 
...
mostly the main disk of \flower.......{\DL blah}.
