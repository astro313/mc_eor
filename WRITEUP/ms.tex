...
$Z\simeq$\,0.5\,$Z_{\odot}$, a molecular gas mass of $M_{\rm
  H2}\simeq$\,5\E{7}\,\Msun, and a SFR of
%mm $\simeq$\,100\,\Msun\,yr\pmOne. [for consistency with the next subsection] 
   30\,--\,80\,\Msun\,yr\pmOne. 
...
in the simulation (see \Sec{ncut}).

Throughout this paper, we 
%mm dub as ``satellite galaxies'' the dense gas regions outside the
%main disk of \flower. 
...
%mm [I moved the next sentence into the main text from the footnote.]
...
\begin{figure*}
% \centering
\includegraphics[width=\textwidth]{\figpath/alpha_vir_ss21-ss22.png}
% \includegraphics[width=0.925\textwidth]{\figpath/alpha_vir-stellar_to_gas_ss21-ss22.png}
\caption{
% Top: 
Virial parameter and mass of MCCs in the pre-starburst (left) and starburst phase (right) of \flower. 
% Bottom: $\alpha_{\rm vir}$ and stellar-to-gas mass ratio of MCCs.
Definition of the symbol shown are the same as in \Fig{larsons_single}.
Blue star symbols show gas-only $\alpha_{\rm vir}$ and blue circulate dots show total $\alpha_{\rm vir, tot}$ of MCCs in \flower. 
Excluding the biggest MCCs, MCCs in the pre-starburst phase have a lower $\alpha_{\rm vir}$ compared to the starburst phase. 
% Overall, the stellar-to-gas mass ratio of MCCs in the starburst phase is higher. 
\label{fig:alpha21-22}}
\end{figure*}
...
% Motivated by \obs, we overplot lines of constants $A_V$ in the mass-size relation shown in \Fig{MR}.
...
As shown in \Fig{alpha21-22}, the total virial parameter (blue dots in the figure) 
...
As \SF proceed, stellar feedback inject kinetic energy in the form of turbulence. As shown in 
\Fig{Mach_stellarRatio}, the Mach number of MCCs with a stellar-to-gas mass ratio of $M_\star/M_{\rm gas} \simeq 0.1 - 1$ 
...
% 
3) overall lower alphavir in the pre-SB phase in \Fig{alpha21-22}. 
...
$M_\star$\eq7.5\E{9}\,\Msun. Thus, the higher velocity dispersion is
...
\Fig{alpha16-28}). Overall, the MCCs we identified are much bigger in
...
%mm different density contours at different 
...
%mm contour levels/surfaces of surface brightness maps/cubes 
...
%mm are highly supersonic, with high 
