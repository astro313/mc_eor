...
Maps of the Toomre $Q$ parameters for the gas, stars, and the effective two-component $Q_{\rm eff}$ are shown in Figures~\ref{fig:Q}, \ref{fig:Qstar}, and \ref{fig:Qeff}, respectively. 
Before accounting for the thickness of the disk and the 
contribution of the stellar component to the gravitational potential, 
most MCs lie in regions of $\log{Q_{\rm gas}}\simeq$\,0 (see \Fig{Q}).
Fragmentation are expected in regions of low Toomre $Q_{\rm eff}$ values.
Further interpretation and implication of this is discussed in \Sec{origin}.


\begin{figure*}[htbp]
\centering
\includegraphics[trim=0 20 10 10, clip, width=0.65\textwidth]{\figpath/{ss16_gas_toomre_proj_0_zoom_2.0_kpc}.png}
\caption{
...
Markers in the surface density and Toomre $Q$ maps
correspond to the mass-weighted positions of MCs identified using the lowest $n_{\rm cut}$. % using 0.32
Positions of sub-MCs identified using lower $n_{\rm cut}$ are not shown (but see top row of \Fig{Qeff} for an example). 
Before accounting for contribution of the stellar component to the 
gravitational potential, we find that most MCs lie in regions of 
$\log{Q_{\rm gas}}\simeq$\,0. 
\label{fig:Q}}
\addtocounter{figure}{-1}
\end{figure*}
...
\begin{figure*}[htbp]
\centering
\includegraphics[trim=0 20 10 10, clip, width=0.65\textwidth]{\figpath/{ss16_gas_toomre_proj_1_zoom_2.0_kpc}.png}
...
\begin{figure*}[htbp]
\centering
\includegraphics[trim=0 20 10 10, clip, width=0.65\textwidth]{{\figpath/ss16_gas_toomre_proj_2_zoom_2.0_kpc}.png}
...
\begin{figure*}[htbp]
\centering
\includegraphics[trim=0 20 10 10, clip, width=0.65\textwidth]{\figpath/{ss16_star_toomre_proj_0_zoom_2.0_kpc}.png}
\caption{
...
\includegraphics[trim=10 0 0 10, clip, width=0.365\textwidth]{\figpath/{ss16_star_SD_proj_0_zoom_2.0_kpc}.png}  
\includegraphics[trim=10 0 0 10, clip, width=0.39\textwidth]{\figpath/{ss16_gas_SD_proj_0_zoom_2.0_kpc}.png} \\
\includegraphics[trim=30 25 30 20, clip, width=0.38\textwidth]{\figpath/{ss16_toomreEff_proj_0_zoom_0.8_kpc_6.81}.png} 
...
and $n_{\rm cut}$\eq6.81\,cm$^{-3}$ (top right) are overplotted as star markers.
Bottom row: Zoom-in view of the effective $Q_{\rm eff}$ (left) and gas surface density (right) maps.
Markers in the bottom left Toomre $Q$ map correspond to positions of MCs identified with $n_{\rm cut}$\eq6.81\,cm$^{-3}$ (same as top right).
Modest smoothing has been applied to the maps. 
A divergent colormap is used for the Toomre $Q$ map to facilitate 
identification of regions above and below $\log{Q_{\rm gas}}$\eq0.
