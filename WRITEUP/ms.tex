...
\end{equation}
where the sum is done over the cells composing each MC.
...
Identifying a new diagnostic tool is beyond the scope of this paper. Here, we are more interested in 
