...
Given the low virial parameter
...
This difference in slopes suggest that mo, albeit speculative due to resolution effects.
In particular, it is possible that we may identify more substructures/smaller and less massive MCs if our simulation 
was of higher resolution (but one must acknowledge that ..... is expeneisve to do zoom-in. This is what we have at best at the 
moment with simulation power).
That said, simularly massive moleuclar clouds have been reported in simulations of higher resolution (i.e., not zoom-in; \citealt{}).
It is therefore conceivable that our results are not that far off.
