...
substructures that are denser as we increase $n_{\rm cut}$. In any case,
...
Speculatively, the shallower slope found in the CMF for \flower compared to those observed in the nearby Universe (see \Sec{cmf}) may
...
% 
Therefore, speculatively... possible that ... the different CMF may suggest different IMF for \flower. 
This could be understood as different cooling properties will lead to different xxx, and thus, Jeans mass/thus determines the final properties of the cloud fragmentation....  
