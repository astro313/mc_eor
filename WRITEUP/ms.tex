...
but this depends on the evolutionary stage of \flower.  % see e.g., test_brute/leaf_fields_ss16-28/18.96_10_fields/Mach_cloud-mass.png
This is consistent with the global analysis done on \flower by \citet{Vallini18a}.
We also compute the Mach number from turbulent and thermal pressures following
\begin{equation}
\mathcal{M} \equiv \sqrt{\frac{P_{\rm NT} + P}{ P }}.
\label{eqn:MPress}
\end{equation}
% to track its variation over the evolutionary stages of \flower.
...
for MCCs of \flower, given the high stellar-to-gas mass ratios of some of them (see \Fig{stellarRatio16}). 
