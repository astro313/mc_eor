...
We show in \Fig{MR} the size-mass relation of the MCs of \flower in its accretion phase (see \Sec{sfh})
compared to 
...
\citet{Kauffmann10c} interpret this empirical relation 
as the threshold for massive \SF.
...
at a given radius. 
We also show the loci of constant surface densities in \Fig{MR}, parameterized through the visual extinction $A_V$.
