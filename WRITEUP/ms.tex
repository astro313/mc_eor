...
\caption{Probability distribution function of the H$_2$ number density
  in \flower during the accreting phase shown in \Fig{SFH}{\em
    (b)}. \MM{PDFs should be normalized to unity by dividing by the
...
accretion phase and the starburst phase of \flower (see
