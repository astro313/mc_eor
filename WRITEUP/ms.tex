...
\AP{the following is cutting the discussion a bit too abruptly; additionally, it might seem contradicting with the fact that we find differences when analysing extreme stages}
We show the properties of all MCCs identified across all evolutionary stages in \Fig{alpha16-28}. We find no quantitative differences over the 700\,Myr traced in our simulation, except for the virial parameter, where the most relevant phases are shown in \Fig{alphaEvol} (see \Sec{singless}).
