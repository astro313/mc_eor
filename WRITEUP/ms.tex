...
\begin{abstract}
We study the properties of molecular cloud (MC) complexes in a prototypical galaxy (``\flower") at redshift $z\approx 6$ using cosmological zoom-in simulations.
%
...
%
Regardless of the H$_2$ density cuts adopted, the MCs are found to have consistently 
