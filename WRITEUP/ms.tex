...
This implies that the velocity dispersion measured in molecular gas structures from \obs on similar physical scales as here
should not be taken as a direct evidence that these gas structures at high redshifts are intrinsically more turbulent than those in the local ISM.
...
have an important contribution from large-scale rotation.} Hence, velocity dispersions measured on these scales should {\em not} be taken as 
a direct evidence of \highz molecular gas structures are intrinsically more turbulent than those in the local ISM,
...
can be understood by acknowledging the fact that a given MCC does not necessary contain CO (as CO forms deeper in
molecular clouds and our simulation does not have enough
