...
\begin{equation}
{\rm voxel_i} = \frac{\sum_i~\rho_{\rm H2, i}~w_i~\Delta z_i}{\sum_i~w_i~\Delta z_i}, 
\label{eqn:integrate}
\end{equation} 
where $\rho_{\rm H2, i}$ is the H$_2$ density of voxel $i$, $w_i$ is the weighted quantity in voxel $i$ which we adopt 
to be the total gas density, and $\Delta z_i$ is the path length of voxel $i$ along the line-of-sight over which the quantities are integrated along.
...
\begin{figure}[htbp]
\centering
\includegraphics[trim=0 0 0 0, clip, width=0.5\textwidth]{\figpath/ss16_alphavir.png}
\includegraphics[trim=0 0 0 0, clip, width=0.5\textwidth]{\figpath/ss16_PVE.png}
\caption{
...
\begin{figure}[htbp]
\centering
\includegraphics[trim=0 0 0 0, clip, width=0.5\textwidth]{\figpath/ss27_alphavir.png}
\includegraphics[trim=0 0 0 0, clip, width=0.5\textwidth]{\figpath/ss27_PVE.png}
\caption{
...
\begin{figure}[htbp]
\centering
\includegraphics[trim=0 0 0 0, clip, width=0.5\textwidth]{\figpath/ss16-28_alphavir.png}
\includegraphics[trim=0 0 0 0, clip, width=0.5\textwidth]{\figpath/ss16-28_PVE.png}
\caption{
...
\begin{figure}[htbp]
\centering
\includegraphics[trim=0 0 0 0, clip, width=0.5\textwidth]{\figpath/ss16-28-alphavir-highncut.png}
\includegraphics[trim=0 0 0 0, clip, width=0.5\textwidth]{\figpath/ss16-28-PVE-highncut.png}
\caption{
...
at a given radius. As shown in \Fig{MR}, the MCs identified in the accretion phase of \flower lie above this relation, along the locus 
...
% 
% \subsubsection{Temporal Evolution in Cloud Dynamics}
% What about all snapshots, where should the results for that go... \Fig{alpha16-28}, \Fig{larsons16-28}, \Fig{larsons16-28-highncut} and \Fig{alpha16-28-highncut}.
...
On the other hand, such massive molecular structures are unknown to Local Group \citep[e.g.,][]{Rice16a}, and are likely the sites 
...
% (While the first stars and galaxies are cooled predominated via atomic H and H$_2$ lines.
...
different contour levels/surfaces on a surface brightness map/cube of a molecular line tracer (e.g., CO, CS, NH$_3$),
...
We also thank the Center for Cosmology and Particle Physics (CCPP) 
