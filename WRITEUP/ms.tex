...
by turbulence and rotation on large scales (occupying the high pressure region shown in the bottom panel of \Fig{alpha16}).
...
Future higher resolution zoom-in simulations would certainly be useful to gunderstand
the evolving dynamical properties of the lower-mass molecular structures in
galaxies at EoR under the influence of gas inflow/outflow.
...
is defined using \Eq{virial} and describes the balance between kinetic and gravitational potential energies.
