...
The apparently large virial parameters seen in the MCCs of \flower can be understood using the Toomre $Q$ parameter (see \Fig{Qeff}). 
We first note that fragmentation {\it can} happen in regions of low $Q$ 
...
%
Thus, the high virial parameter found for most MCCs in \flower 
indicates that some of them are not collapsing structures (but the virial parameter varies depending on the evolutionary stage 
of \flower). Hence, some MCCs are found to lie in regions of $Q_{\rm eff}>1$.
