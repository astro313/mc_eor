...
%
We show that large-scale rotation is an important contributor to the velocity dispersion of some MCCs, even in the highly disturbed phase of \flower.
...
% GMCs in nearby galaxies: 10^5 < M < 1e7 Msun \citep{Rosolowsky03a, Freeman17a}
%
...
include a large number of stellar mass that is already ensembled in \flower
...
\DL{interpretation To be revised ...}
{\em This indicates that gas velocity dispersions observed on similar physical scales and resolutions as presented here have an important contribution from large-scale rotation.}....
%
...
\citet{Behrendt16a} draw a similar conclusion using pc-scale resolution simulation: large-scale bulk motions may mimic turbulent velocity dispersion due to beam smearing.
...
Their velocity dispersions are comparable to those observed in $z$\ssim2 starburst galaxies ($\sigma_{\rm gas}\simeq200$\,\kms);
\DL{TBD} however,
