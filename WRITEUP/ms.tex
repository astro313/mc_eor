...
%
In \flower, the typical MCC mass and size are $M_{\rm gas}\simeq10^{6.5}$\,\Msun and $R\simeq45-100$\,pc,
...
similar to those found in nearby and $z$\ssim2 gas-rich starburst galaxies.
%
...
\caption{Cloud mass and stellar-to-gas mass ratio of MCCs identified in the accreting phase of \flower with different $n_{\rm cut}$. The most massive structures identified with a low $f_{\rm gas}$ correspond to the molecular disk/arms of \flower (see also \Fig{vv}).
%
...
%
Gas-only $\alpha_{\rm vir}$ (orange star symbols) is overplotted, and is of the same order of magnitude as $\alpha_{\rm vir, tot}$ for most MCCs since they are gas-dominated (see \Fig{stellarRatio16}) \AP{I think the orange points makes the figure more messy, an alternative would to remove them and discuss the point in the text}.
%
...
%mm2 sets
    values
of $n_{\rm cut}$ % in identifying the MCCs
to test the robustness of our results against the choice of density threshold.
That is, how sensitively are the structure properties, and thus, the
...
However, the sizes of MCCs are almost a factor of two smaller. This
%mm2 likely suggest
    suggests
that the sizes of \highz molecular gas structures reported in the literature
are
%mm2
   probably
limited by the spatial resolution.
%
The velocity dispersions of some MCCs are also comparable to the most turbulent gas clouds observed in the inner Milky way and nearby gas-rich galaxies (e.g., M64; \citealt{Oka01a, Rosolowsky05a, Heyer09a, Leroy15a}), which lie along the locus of $\sigma_{\rm gas}\propto R^{0.56}$. Such high velocity dispersion
...
%mm2
   This contrasts with \citet{Krumholz18}, who show that numerical models and analytic arguments point to
   feedback generally not being able to produce velocity dispersions of more than 10--20 km~s$^{-1}$, with
   higher velocities likely being produced by Toomre instability driven radial inflow.
...
%mm2 of \flower
are found throughout the disk. This difference likely stems from the different physical mechanisms giving rise to the formation (and thus the nature) of these molecular structures.
%
...
Excluding the main structure (disk of \flower) identified, the typical mass and size of MCC is $R\simeq\,50$\,pc
and $M_{\rm gas}\simeq\,10^{6.5}$\,\Msun, respectively.
...
MCCs observed in gas-rich star-forming galaxies at \z\ssim2, for instance, those reported in \citet{Swinbank11a}.
...
With the Next Generation VLA (ngVLA), which is approximately ten times more sensitive than ALMA, direct observations of molecular gas clouds in galaxies at the EoR on cloud scales will be possible via the higher-$J$ rotational transitions of CO in the 2030s.
% 0.005" highest freq
