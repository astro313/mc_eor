...
Maps of the Toomre $Q$ parameters for the gas, stars, and the effective two-component $Q_{\rm eff}$ are shown in Figures~\ref{fig:Q}, \ref{fig:Qstar}, and \ref{fig:Qeff}, respectively (see \Fig{h2density} for an example of MCs identified 
...
Toomre $Q$ parameter (see Figures~\ref{fig:Q}\,r$-$\,\ref{fig:Qeff}). 
