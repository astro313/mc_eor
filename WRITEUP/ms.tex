...
\begin{abstract}
We study the dynamical properties of molecular clouds complexes (MC) in a prototypical galaxy (\flower) and its satellite galaxies at the Epoch of Reionization (EoR) using cosmological zoom-in simulation.
%
...
%
We compute the effective two-component Toomre $Q$ parameter (gas and stars) to examine regions that are unstable to local axisymmetric perturbations. 
%
...
%
We find $\alpha_{\rm vir}\approx$\,2 for the MCs in the satellite galaxies, which we interpret as result of the weaker stellar feedback and less frequent \SF compared to \flower. Our results suggest that the more massive and bigger MCs compared to the Milky Way manifest from the higher gas mass fraction, surface density, and velocity dispersion.
...
\begin{figure*}[htbp]
\centering
\includegraphics[trim=0 20 30 30, clip, width=0.85\textwidth]{\figpath/{ss16_gas_toomre_proj_0_zoom_2.0_kpc}.png}
\caption{
...
\begin{figure*}[htbp]
\centering
\includegraphics[trim=0 20 30 30, clip, width=0.85\textwidth]{\figpath/{ss16_gas_toomre_proj_1_zoom_2.0_kpc}.png}
...
\begin{figure*}[htbp]
\centering
\includegraphics[trim=0 20 30 30, clip, width=0.85\textwidth]{{\figpath/ss16_gas_toomre_proj_2_zoom_2.0_kpc}.png}
...
\begin{figure*}[htbp]
\centering
\includegraphics[trim=0 20 30 30, clip, width=0.85\textwidth]{\figpath/{ss16_star_toomre_proj_0_zoom_2.0_kpc}.png}
\caption{
...
\begin{figure*}[htbp]
\centering
\includegraphics[trim=0 0 20 0, clip, width=0.55\textwidth]{\figpath/{ss16_toomreEff_proj_0_zoom_2.0_kpc}.png}
\includegraphics[trim=10 0 0 0, clip, width=0.4\textwidth]{\figpath/{ss16_gas_SD_proj_0_zoom_2.0_kpc}.png}
\caption{
Effective two-component Toomre Q (left) and gas surface density (right) maps projected onto the $xy$-plane.
Modest smoothing has been applied to the maps. 
A divergent colormap is used for the Toomre $Q$ map to facilitate 
identification of regions above and below $\log{Q_{\rm gas}}$\eq0.
\DL{Ignore the crosses for now....Please compare by eye for the time being.}
\label{fig:Qeff}}
% \addtocounter{figure}{-1}
\end{figure*}
\clearpage
