...
Such resolution is in principle within reach using ALMA, for which 0\farcs01 resolution images can be attained using the high frequency bands. % Due to effect of the cosmic microwave background (CMB),
Resolving the molecular gas at the EoR on similar resolution can have achieved by observing the higher-$J$ transitions of the CO
lines using the Next Generation VLA (ngVLA) in the 2030s.
% 0.005" highest freq
