...
Maps of the Toomre $Q$ parameters for the gas, stars, and the effective two-component $Q_{\rm eff}$ are shown in \Fig{Q} 
(see also \Fig{h2density} for an example of MCs identified in this evolutionary stage of \flower
...
scale height ratio of $h/r_{\rm gal}$\ssim150\,pc/1\,kpc$\simeq$\,0.15) and since \flower is more of a warped disk.
That is, some MCs are located in regions of $Q_{\rm gas}$\ssim1, but 
...
\caption{
Toomre $Q$ maps derived from the gas (left) and stellar (middle) components, respectively. 
A map of the effective two-component Toomre $Q_{\rm eff}$ parameter is shown in the right panel. 
