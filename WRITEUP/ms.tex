...
\begin{abstract}
We study the dynamical properties of molecular clouds complexes (MC) and their temporal evolution in a prototypical galaxy (\flower)
and its satellite galaxies at the Epoch of Reionization (EoR) using cosmological zoom-in simulation.
We use a clump-finding algorithm and H$_2$ density to identify MCs and their sub-structures.
We compare the mass, size, velocity dispersion, gas surface density, and virial parameter ($\alpha_{\rm vir}$)
of each MC with those observed in the Milky Way, the Galactic center,
...
The mass scale of the MCs is on the order of $10^{6.5-9}$\,\Msun.
...
The velocity dispersion and gas surface density are found to be systematically higher than nearby galaxies
regardless of the $n_{\rm cut}$ adopted, with $\sigma\gtrsim$\,100\,\kms.
This likely results from the strong supernova and stellar feedback \flower experienced over multiple episodes of
bursty \SF and constant cosmic gas inflows.
Our results suggest that the more massive and bigger MCs of \flower compared to the Milky Way
...
Virial analysis indicates that the MCs found in the main disk of \flower are unbound, but its substructures have lower virial parameters,
 consistent with the notion that collapsing structures result from gravitational instability within globally stable structures, which are
...
galaxy.
{\bf AF: need aim and objectives of the study}
...
That said, based on the scaling of $M_J$\eq$\sigma^4/(G^2\Sigma)$ for the Jeans mass,
