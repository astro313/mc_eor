...
$Z\simeq$\,0.5\,$Z_{\odot}$, a molecular gas mass of $M_{\rm
  H2}\simeq$\,5\E{7}\,\Msun, and a SFR of $\simeq$\,
%mm [not according to Figure 1] 100
     50--70
\,\Msun\,yr\pmOne. \MM{What is its gas fraction?  I ask because its
  molecular gas mass is minuscule, particularly for such a high SFR:
  this is a depletion time of only 0.7--1 Myr, while modern galaxies
  usually have depletion times more like 0.5--2~{\em Gyr!}} Its effective stellar radius  is $\sim$0.5\,kpc and the dark matter virial radius is $r_{\rm 200}\simeq$\,15\,kpc.
