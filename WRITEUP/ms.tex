...
bursty \SF and cosmic gas inflows.
...
Virial analysis indicates that the MCs in the main disk of \flower are unbound, but its substructures have lower virial parameters,
...
We find $\alpha_{\rm vir}\approx$\,2 for the MCs in the satellite galaxies, which we interpret as result from the weaker stellar feedback
...
will furnish useful data to test our findings and simulation to shed
...
\label{eqn:Q}
\end{equation}
For a thin disk, where $kh\ll1$, Equation~\ref{eqn:3Ddisp} reduces to the thin disk approximation, which 
...
we consider the approximation for the effective two-component $Q_{\rm eff}$ parameter following \citet{Romeo11a} which is 
...
\begin{equation}
T\approx
0.8+0.7\left(\frac{\sigma_{z}}{\sigma_{R}}\right)\,.
\end{equation}
