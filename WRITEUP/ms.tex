...
has the potential to provide useful observational data to test our findings and the validity of our simulation to shed
...
likely result from the higher gas mass fraction, surface density, and velocity dispersion, 
which set the scale for fragmentation.
This is consistent with what has been found previously in higher resolution isolated simulation.
Here, our cosmological zoom-in simulation allows us to examine 
...
provides a way to examine and postulate the morphology and dynamics of
the multi-phase ISM structures of the first galaxies and their satellite galaxies.
High resolution imaging of the first galaxies with ALMA and the ngVLA 
has the potential to provide useful observational data to test our findings and the validity of our simulation to shed
light on \SF since the cosmic dark ages.

In this work, we utilize high-resolution realistic hydrodynamics simulation with
