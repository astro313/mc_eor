...
to \obs.
%
In \flower, the typical MCC mass is $10^{6.5}$\,\Msun, with sizes $R\lesssim100$\,pc, comparable to nearby spirals and starburst galaxies.
%
...
identifying clumps based on/after applying S/N-clipping, using tools such as \ncode{aips}'s task \ncode{serch}, \ncode{clumpfind}, and \ncode{cprops}; e.g., \citealt{Williams94a, Oka01a, Rosolowsky06a, Rosolowsky08a, DonovanMyer13a}).
%
...
Such variation in $\sigma^2/R$ is observed in GMCs in the central and outer part of the Milky Way \citep{Oka01a, Heyer09a}.
...
The gas surface density of MCCs in both accreting and starburst phases is higher than the Milky Way at 8\,kpc, but comparable to 
those observed in starburst galaxies and the nearby ULIRGs \citep{Boulares90a, Scoville91a, Weiss01a, Leroy15a}.
% M82: 0.1 g cm^-2
% Arp 220: 7-20 g cm^-2
%
...
Such high pressure is comparable to those observed in local ultra-luminous IR galaxies (ULIRGs; 
e.g., \citealt{}); however, the molecular clouds in the latter are concentrated within their central regions \citep{Downes98a, Sakamoto08a}. In our simulated galaxy, the high pressure MCCs of \flower are found throughout the disk. This difference likely stems from the different physical mechanisms giving rise to the formation (and thus the nature) of these molecular structures.
%
...
non-thermal pressure. Similarly massive molecular structures 
have been observed in nearby star-forming and starburst galaxies \citep[e.g.,][]{DonovanMeyer13a, Colombo14a, Leroy15a},
