...
%Q^{-1}_{\rm eff} =  \left\{
%				\begin{array}{lccr}
%					     {\displaystyle\frac{w}{T_{\rm star} Q_{\star}} + \frac{1}{T_{\rm gas} Q_{\rm gas}}}      & & & \mbox{if\ }T_{\rm star} Q_{\star} \geq T_{\rm gas} Q_{\rm gas} \\ [0.75em]
%                                               {\displaystyle\frac{1}{T_{\rm star} Q_{\star}} + \frac{w}{T_{\rm gas} Q_{\rm gas}}}      & & & \mbox{if\ }T_{\rm star} Q_{\star} \leq T_{\rm gas} Q_{\rm gas} \\				
%				\end{array} 
%			    \right.
Q^{-1}_{\rm eff} =  \left\{
				\begin{array}{lccr}
