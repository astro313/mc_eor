...
\subsection{Distributions of MCC Basic Properties and Outlier}
\begin{figure*}[htbp]
\centering
...
Such structure has velocity dispersion dominated by bulk motions, as shown in \Fig{vv}, where we compare 
the velocity dispersions of MCCs  
resulting from bulk ($\sigma_{\rm bulk}$) versus non-thermal turbulent motions ($\sigma_{\rm NT}$) 
for the accreting and quiescent phases of \flower.
The accreting phase (\Fig{MCC}) of \flower displays a disturbed morphology compared to the
quiescent phase, which displays a disk-like morphology (\Fig{MCC28}).
Excluding the molecular disk, the velocity dispersions of most MCCs in the accreting phase of \flower 
...
\caption{Gas velocity dispersions from bulk motions and turbulent motions for MCCs identified in accreting (top) and
quiescent phase (bottom) of \flower across all $n_{\rm cut}$ (same color-coding as \Fig{stellarRatio16}).
...
At a given gas surface density, MCCs display a range of $\sigma^2/R$. 
Such variations in $\sigma^2/R$ is observed in GMCs of the Milky Way \citep{Heyer09a}.
...
The variation in $\sigma^2/R$ with $\Sigma$ seen here suggests that column density is not a fundamental properties of 
...
% Starburst
In the starburst phase, MCCs have similar velocity dispersion and sizes as those in the accreting phase; however, 
...
That is, more MCCs in the starburst phase of \flower are more susceptible to collapse.
%
...
As mentioned in \Sec{}, the most massive cloud identified at low H$_2$ gas density threshold corresponds to the molecular 
disk of \flower, and is broken down into multiple smaller MCCs at higher 
