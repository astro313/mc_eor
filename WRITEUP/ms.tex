...
\caption{Number distribution of molecular gas density of \flower during the accreting phase shown in \Fig{SFH}{\em
    (b)}. 
\label{fig:h2density}}
\end{figure}
...
In \Fig{h2density}, we show the probability distribution of H$_2$
...
%mm typical size $R\gtrsim 60$\,pc [revised assuming spherical MCCs
%per Sect 4.2]
...
like total gas mass. AP will add disclaimer in Section 3. Will double check 
Mcl for all ncut and address AF's comment.}
...
We first focus on the two most extreme evolutionary stages of \flower---the accreting and starburst phases (see \Sec{sfh}), and identify a set of MCCs in each of them. Scaling relations for the MCCs are shown in \Fig{larsons_single} for the accreting (left panels) and starburst phase (right), respectively. Let us start from analyzing the accreting phase.
...
increasing $n_{\rm cut}$. \MM{which direction? White high or blue
  high?} Literature data are compiled from \citet{Beuther02a, Mueller02a, Hill05a, Motte07a}. 
...
\Fig{larsons_single}). \MM{I'm not entirely sure what this sentence is
