...
We find that the MC of \flower are highly supersonic, with large velocity dispersion ($\sigma\approx$\,200\,\kms) comparable to 
...
corresponds to the arms of the main disk of \flower and breaks down into smaller $\lesssim$100\,pc-scale MCs at higher density thresholds. 
We find that the ...
The MCs in the satellites..
consistent with PVE.
We find no temporal variations in the MC physical properties over the course of 700\,Myr traced in our simulation, at least in terms of the scaling relations examined. 
Our results are independent of the volume density threshold adopted, except for the slope of the cumulative 
mass distribution, which steepens as we increase $n_{\rm cut}$. Higher resolution cosmological zoom-in simulations 
will shed light into ... , as we .... from observations.
\end{abstract}
