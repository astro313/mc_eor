...
{\bf The stellar-to-halo mass ratio of \flower ($M_\star/M_{\rm DM}$\eq0.07) is 
between?? those from abundance matching reported by \citet{Moster13a},
but higher than those reported based on other zoom-in simulations at similar redshifts 
(e.g., \citealt{Ceverino17a, Katz17a}, and \citealt{Behroozi19a}). This can result from different feedback implementations.
}
