...
{\bf $M_{\rm DM}\simeq$\eq3.5\,$\times$\,10$^{11}$\,\Msun} at the center of a cosmic web knot, and accretes mass from the IGM mainly via three filaments of length $\simeq$\,100\,kpc. \flower has a stellar mass of {\bf $M_\star\simeq$\,2.6\E{10}\,\Msun}, a metallicity of $Z\simeq$\,0.5\,$Z_{\odot}$, a molecular gas mass of $M_{\rm H2}\simeq$\,5\E{7}\,\Msun, and a SFR of 30\,--\,80\,\Msun\,yr\pmOne.
%
...
This is a factor of about 3 higher than the typical value inferred by abundance matching models, that typically gives $\sim0.02$. 
...
is for a halo mass between $M_{\rm halo}$\ssim10$^{10.5}$--$10^{12}$\,\Msun, whereas in the same paper the authors find 
0.01--0.05 in the same mass range from direct abundance matching 
(see the Appendix therein). 
Additionally, from an earlier abundance matching study, \citet{Moster13a} find a ratio 0.005, i.e., within a factor 3 from \citet{Behroozi13b}.}.} 
...
The former with n$_{\rm gas}<100$\,\cc and n$_{\rm H2} < 5$\,\cc, whereas the latter with 
n$_{\rm gas}$\ssim$100$\,\cc and n$_{\rm H2} \gtrsim10$\,\cc (see also Fig. 5 of \citet{Pallottini17b} 
for details\footnote{In particular, with their analysis of the Minkowski function of the molecular density field (see Fig. 6 therein)}). 
...
for the disk/interarm, $f_{\rm H2}$\ssim14\% and for the MCCs, $f_{\rm H2}$\ssim28\%. 
Note that for the lowest value of the H2 cuts, this fraction might be lower; however, 
